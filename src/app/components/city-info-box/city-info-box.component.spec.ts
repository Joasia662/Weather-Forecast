...
describe('CityInfoBoxComponent', () => {
    ...
    it('ngOnInit should convert cityInfo.sunrise timestamp (1754190732) to Date, format it properly and assign it to local variable sunrise("2025-08-03T03:12:12.000Z")', () => {
        component.ngOnInit();

        expect(component.sunrise).toEqual(new Date("2025-08-03T03:12:12.000Z"));
    })

    it('ngOnInit should convert cityInfo.sunset timestamp (1754245246) to Date, format it properly and assign it to local variable sunset("2025-08-03T18:20:46.000Z")', () => {
        component.ngOnInit();
